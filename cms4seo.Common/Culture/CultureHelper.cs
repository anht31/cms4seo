...
namespace cms4seo.Common.Culture
{
    public static class CultureHelper
    {
        ...
        #region cms4seo.com custom code

        public static string GetLanguageWithoutCountry()
        {
            ...
            return CultureInfo.CurrentCulture.Parent.EnglishName;
        }
