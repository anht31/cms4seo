...
namespace cms4seo.Admin.Controllers
{
    ...
    [Authorize(Roles = "Medium.UsersAdmin")]
    public class UsersAdminController : BaseController
    {
            ...
            params string[] selectedGroups)
        {
            if (ModelState.IsValid)
            {
                ...
                if(adminresult.Errors.Any())
                    ModelState.AddModelError("", adminresult.Errors.FirstOrDefault());
            }
            ...
            params string[] selectedGroups)
        {
            ...
            ModelState.AddModelError("", AdminResources.UsersAdminControllerEditSomethingFailed);
            return View();
        }
