    ...
    public class ProductController : BaseController
    {
        ...
        public async Task<ActionResult> Edit(Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //if (product.IsCreate)
                //{
                //    product.Tags = product.Tags.Select(tag => tag.MakeUrlFriendly()).ToList();
                //}
                ...
                foreach (var newTag in listNewTag)
                {
                    ...
                    db.ProductTags.Add(new ProductTag() { Name = newTag, Slug = newTag.MakeUrlFriendly() });
                }
                db.SaveChanges();
                ...
                if (!product.IsCreate)
                {
                    ...
                    // temp to try new solution for update productTag
                ...
                if (!product.IsCreate && product.SelectedProductTag != null)
                {
                ...
                if (!product.IsLockSeo || !Setting.WebSettings[WebSettingType.IsLockSeoMetaTag].ToBoolean())
                {
