...
if (document.getElementsByClassName("html-highlighter").length > 0) {


    w3CodeColor(document.getElementsByClassName("html-highlighter")[0]);
    ...
    function w3CodeColor(elmnt, mode) {
        ...
        function jsMode(txt) {
            ...
            while (y == 1) {
                ...
                if (Math
                    .max(numpos[0], sfnuttpos[0], dfnuttpos[0], compos[0], comlinepos[0], keywordpos[0], dotpos[0]) ==
                    -1) {
                    break;
                }
        ...
        function getKeywordPos(typ, txt, func) {
            ...
            if (typ == "js") {
                words = [
                    ...
                    "do", "double", "else", "enum", "eval", "export", "extends", "false", "final", "finally", "float",
                    "for", "function", "goto", "if", "implements", "import",
                    "in", "instanceof", "int", "interface", "let", "long", "NaN", "native", "new", "null", "package",
