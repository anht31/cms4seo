 ...
 *
 * Modify by cms4seo (https://cms4seo.com/)
 * to extension Client Resize image
...
IsImage = function(file) {
    ...
    if (extension.match(/.(jpg|jpe|jpeg|bmp|png|gif|webp)$/i)) {
        return true;
    };
...
(function ($) {
    ...
    DmUploader.prototype.processQueue = function () {
        ...
        /* ==============================================
        little hack inject client resize for BIG image & post DataURI - Begin
        =============================================== */

        if (IsImage(file)) {

            widget.imageResize(file, 1920, 1080, uploadServerCallback);

            function uploadServerCallback(image) {
        ...
        /* ==============================================
        little hack inject client resize for BIG image & post DataURI - End
        =============================================== */
    ...
    DmUploader.prototype.imageResize = function (file, maxWidth, maxHeight, callback) {
        ...
        var mimeType = "image/jpeg"; // default if not detect
        ...
        img.onload = function () {
            ...
            if (width > max_WIDTH) {
                ...
                hiddenCanvas.height = height * max_WIDTH / width;
            ...
            //var smallBlob = new Blob([smallArr], { type: 'image/jpeg'});

            var outputFile = new File([imageArray], file.name);
