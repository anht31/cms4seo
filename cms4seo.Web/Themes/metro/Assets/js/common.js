...
/* affix menu for Header menu ================================================ */


//$(window).on('scroll', function (event) {

//    var headerObjectHeight = 110;

//    if($("#container-header-ads").length)
//    {
//        headerObjectHeight = $("#container-header-ads").height();
//    }
    

//    var scrollValue = $(window).scrollTop();
//    if (scrollValue > headerObjectHeight) {
