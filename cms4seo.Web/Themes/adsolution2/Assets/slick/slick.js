...
(function(factory) {
    ...
    Slick.prototype.progressiveLazyLoad = function() {
        ...
        if (imgCount > 0) {
            ...
            targetImage.attr("src", targetImage.attr("data-lazy"))
                .removeClass("slick-loading")
                .load(function() {
    ...
    Slick.prototype.selectHandler = function(event) {
        ...
        var targetElement =
            $(event.target).is(".slick-slide") ? $(event.target) : $(event.target).parents(".slick-slide");
    ...
    Slick.prototype.swipeHandler = function(event) {
        ...
        if (_.options.verticalSwiping === true) {
            _.touchObject.minSwipe = _.listHeight /
                _.options
                .touchThreshold;
        }
    ...
    Slick.prototype.focusHandler = function() {
        var _ = this;
        _.$slider.on("focus.slick blur.slick",
            "*",
            function(event) {
                event.stopImmediatePropagation();
                var sf = $(this);
